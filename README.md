...
- [Copy & Paste] git clone git@github.com:DianaBeki/Webpack.git
...
- git clone git@github.com:DianaBeki/Webpack.git
### Install
...
Feel free to check the [issues page](https://github.com/DianaBeki/Webpack/issues).
